...
Característica: Como Ana la representante, quiero poder enviar notificaciones a los clientes, para brindarles información sobre el estado de sus paquetes.
